...
if (kendo.ui.Spreadsheet) {
	...
	/*将CELL_CONTEXT_MENU中的Copy等替换成复制*/
	kendo.spreadsheet.messages.dialogs =$.extend(true, kendo.spreadsheet.messages.dialogs,{
		okText: '确定',
		modifyMergedDialog: { errorMessage: '无法更改合并单元格的一部分。' },
		overflowDialog: { errorMessage: '不可粘贴， 因为复制区域和粘贴区域的大小和形状不一样。' },
		useKeyboardDialog: {
            title: '复制和粘贴',
            errorMessage: '如果这些动作不能通过菜单调用，请用键盘快捷键代替：',
            labels: {
                forCopy: '复制',
                forCut: '剪切',
                forPaste: '粘贴'
	...
	kendo.spreadsheet.messages.view =$.extend(true, kendo.spreadsheet.messages.view,{
	        errors: {
	            openUnsupported: '不支持该格式。请选择一个xlsx文件。',
	            shiftingNonblankCells: '由于数据丢失的可能性，无法插入单元格。请选择另一个插入位置或从工作表的结尾删除数据。',
	            filterRangeContainingMerges: '无法在包含合并的范围内创建筛选器',
	            sortRangeContainingMerges: '无法排序包含合并的范围',
	            validationError: '您输入的值违反了在单元格上设置的验证规则。'
	        }
	});
}
